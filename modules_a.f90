    ...
    real(dl) :: myparameter1,myparameter2,myparameter3,myparameter4,myparameter5,myparameter6
...
500     if (L< lmax_extrap_highl) &
    ...
    real(16) Omegam0,Omegar0,H0inMpcinsec
    !,grhog
...
!    CP%Num_Nu_massless=grhornomass/grhor
   ! print*,CP%omegac,CP%omegab,CP%Omegan
   !print*,CP%omegac*CP%h0*CP%h0/(100.*100.)
