    ...
    myparameter1 = Ini_Read_Double('myparameter1')
    myparameter2 = Ini_Read_Double('myparameter2')
    myparameter3 = Ini_Read_Double('myparameter3')
    ...
    read(buffer,*) corerank
   ! print*,P%H0
    call getarg(3,buffer)
    read(buffer,*) P%H0
    
    call getarg(4,buffer)
    read(buffer,*) P%omegab
    P%omegab = P%omegab/(P%H0/100)**2
    call getarg(5,buffer)
    read(buffer,*) P%omegac
    P%omegac = P%omegac/(P%H0/100)**2
	call getarg(6,buffer)
	
	read (buffer,*) myparameter1
    call getarg(7,buffer)	
    read (buffer,*) myparameter2
    call getarg(8,buffer)
    read (buffer,*) myparameter4
   ...
   !  call getarg(8,buffer)
!     read (buffer,*) P%Reion%optical_depth

    call InitialPower_ReadParams(P%InitPower, DefIni, P%WantTensors)
   ! call getarg(9,buffer)
   ! print*,P%InitPower%ScalarPowerAmp
   ! read (buffer,*) P%InitPower%ScalarPowerAmp
