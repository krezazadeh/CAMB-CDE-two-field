! equations_ppf-RK4-lambdaphit.f90
...
& real(lambdachit,16),real(phitinitial,16),real(chitinitial,16)),8)
...
function Hta2(ainput,rhomtinitialinput,rhortinitialinput, &
     & lambdachitinput,phitinitialinput,chitinitialinput)

implicit none

real(16) :: ainput,rhomtinitialinput,rhortinitialinput, &
            &   lambdachitinput,phitinitialinput,chitinitialinput
real(16) :: Hta2
...
real(16) :: rhomtinitial,rhortinitial,lambdachit,phitinitial,chitinitial
common /inputparametersofHta/ rhomtinitial,rhortinitial,lambdachit, &
...
real(16) :: rhomtinitialflag,rhortinitialflag,lambdachitflag,phitinitialflag, &
            & chitinitialflag
common /flags/ rhomtinitialflag,rhortinitialflag,lambdachitflag,phitinitialflag, &
            & chitinitialflag
